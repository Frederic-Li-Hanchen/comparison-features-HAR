...
from trainDnn import dataPath, dnnFeaturesPath, modelParamPath, batchSize, selectedModel
...
#-------------------------------------------------------------------------------------------------------
# Function extractDnnFeatures: compute the features on the data and save them at the specified location
#-------------------------------------------------------------------------------------------------------
def extractDnnFeatures(
  ...
  print('Loading the training and testing data from ' + dataPath)
  ...
  if selectedModel.name == 'AE':
    ...
    input_shape = (trainShape[1]*trainShape[2],)
...
if __name__ == '__main__':
  ...
  print('#############################################################')
  print('Computing DNN features on the training and testing sets')
  print(dataPath)
  print('#############################################################')
  # Important NOTE: the script in its current form overwrites previously saved features in the case of the LOSO Cross-Validation
